import { generateSEOFriendlyURL } from './url-utils'
...
// Core locations for URL generation
const CORE_LOCATIONS: SimpleLocation[] = [
  {
    name: 'New York',
    ...
    urlSlug: 'new-york',
    category: 'major_city',
    keywords: ['nyc', 'manhattan', 'brooklyn', 'queens', 'bronx']
  },
  {
    name: 'London',
    ...
    urlSlug: 'london',
    category: 'capital',
    keywords: ['uk', 'england', 'britain', 'westminster', 'city']
  },
  {
    name: 'Paris',
    country: 'France',
    ...
    urlSlug: 'paris',
    category: 'capital',
    keywords: ['france', 'eiffel', 'louvre', 'seine', 'champs']
  },
  {
    name: 'Tokyo',
    country: 'Japan',
    ...
    urlSlug: 'tokyo',
    category: 'capital',
    keywords: ['japan', 'shibuya', 'shinjuku', 'ginza', 'harajuku']
  },
  {
    name: 'Sydney',
    country: 'Australia',
    ...
    urlSlug: 'sydney',
    category: 'major_city',
    keywords: ['australia', 'harbour', 'opera', 'bridge', 'bondi']
  },
  {
    name: 'Dubai',
    ...
    urlSlug: 'dubai',
    category: 'major_city',
    keywords: ['uae', 'burj', 'emirates', 'marina', 'downtown']
  },
  {
    name: 'Singapore',
    country: 'Singapore',
    ...
    urlSlug: 'singapore',
    category: 'capital',
    keywords: ['marina', 'gardens', 'sentosa', 'orchard', 'chinatown']
  },
  {
    name: 'Los Angeles',
    country: 'United States',
    ...
    urlSlug: 'los-angeles',
    category: 'major_city',
    keywords: ['la', 'hollywood', 'beverly', 'santa', 'venice']
  }
]

// Static redirects for common patterns
const STATIC_REDIRECTS: SimpleRedirect[] = [
  {
    from: '/gh/*',
    to: '/golden-hour/*',
    type: 'permanent',
